...
namespace GAS.Core
{
    public class BinaryManager
    {
        ...
        /// <summary>
        /// Gets the standard local application workspace directory: %USERPROFILE%\.GAS
        /// </summary>
        public static string WorkspaceDirectory
        {
            get
            {
                ...
                return Path.Combine(home, ".GAS");
            }
        }

        /// <summary>
        /// Gets the local app data support directory: %APPDATA%\GAS
        /// </summary>
        public static string AppSupportDirectory
        {
            get
            {
                ...
                return Path.Combine(appData, "GAS");
            }
        }

        /// <summary>
        /// Gets the runtime support directory (e.g. %APPDATA%\GAS\runtime)
        /// </summary>
